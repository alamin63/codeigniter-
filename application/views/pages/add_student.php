...
<div class="container">
	...
	<form method="POST" action="<?php echo base_url();?>save-student">
	  <div class="mb-3">
	  ...
	  <div class="mb-3">
	    ...
	    <input type="text" name="student_phone" class="form-control" id="studentPhone">
	  </div>
	  <div class="mb-3">
	    <label for="studentRoll" class="form-label">Student Roll</label>
	    <input type="number" name="student_roll" class="form-control" id="studentRoll">
	  </div>
